  ...
  if (error)
    return (
      <div className="flex min-h-screen bg-gray-100">
        <Sidebar />
        <div className="flex-1 p-8 flex items-center justify-center">
          <h2 className="text-error">Error: {error}</h2>
        </div>
      </div>
    );
    ...
    <div className="flex min-h-screen bg-gray-100 text-black dark:bg-[#242F59] dark:text-white">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-xl font-bold mb-6">
          BUAT SOAL - {mapel?.toUpperCase()}
        </h1>

        {showForm && (
          <form
            onSubmit={handleFormSubmit}
            className="bg-white shadow-md rounded-lg p-8 mb-6 dark:bg-[#0F103F]"
          >
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormInput((prev) => ({ ...prev, opsiA: e.target.value }))
                }
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                required
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormInput((prev) => ({ ...prev, opsiB: e.target.value }))
                }
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                required
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormInput((prev) => ({ ...prev, opsiC: e.target.value }))
                }
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                required
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormInput((prev) => ({ ...prev, opsiD: e.target.value }))
                }
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                required
              />
            ...
            {soal.length === 0 ? (
              <div className="bg-white shadow-md rounded-lg p-8 text-center dark:bg-[#0F103F]">
                ...
                <button
                  ...
                  className="btn btn-success dark:btn-primary mt-4"
                >
                  Simpan Soal
                </button>
              </div>
              ...
              soal.map((item, index) => (
                <div
                  ...
                  className="flex bg-white shadow-md rounded-lg mb-6 overflow-hidden dark:bg-[#0F103F]"
                >
                  ...
                  <div className="flex flex-col items-center bg-[#278550] px-2 py-4 text-white gap-3 dark:bg-primary">
                    <button
                      ...
                      className="btn btn-ghost text-xs hover:btn-accent dark:hover:btn-info dark:hover:text-white"
                    >
                      <FaPen />
                    </button>
                    <button
            ...
            <div className="grid grid-cols-5 gap-6">
              {soal.map((_, i) => (
                <button
                  ...
                  className="btn btn-lg dark:text-white bg-white border-1 text-md w-full text-black focus:bg-[#278550] dark:focus:bg-primary focus:text-white dark:bg-[#242F59]"
                >
                  {i + 1}
                </button>
              ))}
